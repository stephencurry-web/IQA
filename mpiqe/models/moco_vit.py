...
class MoCo(nn.Module):
    ...
    def __init__(self, config, dim=384, K=65536, m=0.999, T=0.07, mlp=False):
        """
        ...
        self.encoder_q = build_model(config)
        self.encoder_k = build_model(config)
    ...
    def forward(self, im_q, im_k, im_label):
        """
        Input:
